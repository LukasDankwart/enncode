...
class MulParser(BaseParser):
    ...
    def parse(self, node, parser):
        """
        Parses the Mul node and updates the parser's internal representation.
        ...
        Side Effects:
            ...
            - Appends a new entry to `parser.nodes` describing the Mul node.
        """
